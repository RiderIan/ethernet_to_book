...
#
# Script generated by Vivado on Wed Jul 15 19:28:09 MDT 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : top_of_book_ila.sh
...
#
# Usage        : top_of_book_ila.sh
#                top_of_book_ila.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                top_of_book_ila.sh [-rerun]
#                top_of_book_ila.sh [-reset_run]
#                top_of_book_ila.sh [-clean]
#                top_of_book_ila.sh [-reset_log]
#                top_of_book_ila.sh [-help]
#
...
#                script (type 'top_of_book_ila.sh -help' for more information).
#
...
# script info
echo -e "top_of_book_ila.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./top_of_book_ila.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../tools/xilinx/2025.2/data/rsb/busdef" +incdir+"../../../../project.gen/sources_1/ip/top_of_book_ila/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../tools/xilinx/2025.2/data/rsb/busdef" +incdir+"../../../../project.gen/sources_1/ip/top_of_book_ila/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.top_of_book_ila xil_defaultlib.glbl -o top_of_book_ila_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./top_of_book_ila_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key top_of_book_ila_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc top_of_book_ila_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./top_of_book_ila.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: top_of_book_ila.sh [-help]\n\
Usage: top_of_book_ila.sh [-step]\n\
Usage: top_of_book_ila.sh [-lib_map_path]\n\
Usage: top_of_book_ila.sh [-rerun]\n\
Usage: top_of_book_ila.sh [-reset_run]\n\
Usage: top_of_book_ila.sh [-clean]\n\
Usage: top_of_book_ila.sh [-reset_log]\n\
Usage: top_of_book_ila.sh [-keep_index]\n\
Usage: top_of_book_ila.sh [-noclean_files]\n\n\
