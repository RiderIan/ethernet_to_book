...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../tools/xilinx/2025.2/data/rsb/busdef" +incdir+"../../../../project.gen/sources_1/ip/top_of_book_ila/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../tools/xilinx/2025.2/data/rsb/busdef" +incdir+"../../../../project.gen/sources_1/ip/top_of_book_ila/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.top_of_book_ila xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.top_of_book_ila -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log top_of_book_ila_sc.so .tmp_log xcelium_lib waves.shm c.obj)
