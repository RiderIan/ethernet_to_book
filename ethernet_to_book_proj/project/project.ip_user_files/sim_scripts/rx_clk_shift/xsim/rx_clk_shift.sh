...
#
# Script generated by Vivado on Wed Jul 15 19:25:30 MDT 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : rx_clk_shift.sh
...
#
# Usage        : rx_clk_shift.sh
#                rx_clk_shift.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rx_clk_shift.sh [-rerun]
#                rx_clk_shift.sh [-reset_run]
#                rx_clk_shift.sh [-clean]
#                rx_clk_shift.sh [-reset_log]
#                rx_clk_shift.sh [-help]
#
...
# script info
echo -e "rx_clk_shift.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rx_clk_shift.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot rx_clk_shift xil_defaultlib.rx_clk_shift xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim rx_clk_shift -key {Behavioral:sim_1:Functional:rx_clk_shift} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb rx_clk_shift.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./rx_clk_shift.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: rx_clk_shift.sh [-help]\n\
Usage: rx_clk_shift.sh [-step]\n\
Usage: rx_clk_shift.sh [-lib_map_path]\n\
Usage: rx_clk_shift.sh [-rerun]\n\
Usage: rx_clk_shift.sh [-reset_run]\n\
Usage: rx_clk_shift.sh [-clean]\n\
Usage: rx_clk_shift.sh [-reset_log]\n\
Usage: rx_clk_shift.sh [-keep_index]\n\
Usage: rx_clk_shift.sh [-noclean_files]\n\n\
