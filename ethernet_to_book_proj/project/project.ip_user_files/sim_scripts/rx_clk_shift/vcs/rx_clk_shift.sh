...
#                script (type 'rx_clk_shift.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.rx_clk_shift xil_defaultlib.glbl -o rx_clk_shift_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./rx_clk_shift_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key rx_clk_shift_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc rx_clk_shift_simv.daidir vcs_lib c.obj)
