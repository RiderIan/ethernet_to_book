...
#
# Script generated by Vivado on Wed Jul 15 19:24:09 MDT 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : system_clocks_gen.sh
...
#
# Usage        : system_clocks_gen.sh
#                system_clocks_gen.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                system_clocks_gen.sh [-rerun]
#                system_clocks_gen.sh [-reset_run]
#                system_clocks_gen.sh [-clean]
#                system_clocks_gen.sh [-reset_log]
#                system_clocks_gen.sh [-help]
#
...
export RDI_DATADIR="/home/ian-rider/tools/xilinx/2025.2/data"
...
# script info
echo -e "system_clocks_gen.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./system_clocks_gen.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot system_clocks_gen xil_defaultlib.system_clocks_gen xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim system_clocks_gen -key {Behavioral:sim_1:Functional:system_clocks_gen} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/ian-rider/tools/xilinx/2025.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb system_clocks_gen.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./system_clocks_gen.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: system_clocks_gen.sh [-help]\n\
Usage: system_clocks_gen.sh [-step]\n\
Usage: system_clocks_gen.sh [-lib_map_path]\n\
Usage: system_clocks_gen.sh [-rerun]\n\
Usage: system_clocks_gen.sh [-reset_run]\n\
Usage: system_clocks_gen.sh [-clean]\n\
Usage: system_clocks_gen.sh [-reset_log]\n\
Usage: system_clocks_gen.sh [-keep_index]\n\
Usage: system_clocks_gen.sh [-noclean_files]\n\n\
